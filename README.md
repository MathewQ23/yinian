...
- 集中链条页：通过导航进入“想法链条”，按根想法集中查看所有延伸树
- 延伸可视化：源头想法卡片会显示它向下长出的所有后续想法，形成一棵轻量树
- 生命周期：每个想法都有“萌芽 / 实践中 / 已验证 / 暂停”状态
- 实践延伸：可以给想法追加实践记录，让想法随着行动继续生长
...
- 想法文本、可选来源、引用关系、生命周期、实践记录、时间戳：LocalStorage
- 上传图片：IndexedDB
